...
brindisi. Non c'è minaccia qui. Solo calore umano prima della tempesta.`,
          notaDM: `Rombia è lo stesso villaggio descritto nella quinta annotazione del diario del Biondo (cap.5): quello colpito dall'epidemia pochi giorni dopo il passaggio di Rahlia e Dogti. I PG non lo sanno ancora. Le storie raccontate durante la festa (cap.2 — "Le Storie della Festa") possono includere proprio quella leggenda — raccontata come voce, superstizione o ricordo di famiglia — così che quando i PG leggeranno il diario al cap.5 il collegamento esploda con più forza.`
        }
      ],
...
• Ysel — Assistente borgomastro. Giovane donna, efficiente, prende nota di tutto. È lei che sa davvero come funziona il villaggio. Il borgomastro lo sa e fa finta di niente.`
        },
        {
          ...
          tipo: "leggenda",
          testo: `Durante la festa, quattro storie del villaggio circolano tra un brindisi e l'altro. Ognuna è raccontata da un PNG diverso già presentato sopra — usale per far respirare il villaggio prima che tutto cambi.`,
