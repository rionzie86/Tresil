...
const TRESIL_DATA = {
  ...
  sezioni: [
    ...
    { id: "fazioni",       label: "Fazioni, Gilde & Leggi", icona: "◆" },
  ...
  personaggi: {
    pg: [
      ...
      },
      {
        ...
        loreMaster: "L'ordine di Naru implanta un incubo rituale nei discepoli: attraverso questo incubo i maestri trasmettono i poteri. Naru è stato impiantato per errore a 8 anni. Il rituale cancella tutti i ricordi precedenti. Naru non sa che i ricordi sono stati cancellati — per lui non c'è un 'prima'.\n\nCrede di non sognare perché non ricorda il suo unico sogno ricorrente: lago di latte, coste di pietra nera, tentacoli che cercano di ghermirlo. Larimar ha vissuto questo sogno dall'interno nella prima sessione, riportandone una cicatrice reale.\n\nLo spirito del bosco di Ruder lo ha chiamato 'abominio' percependone la natura anomala.\n\nVOLONTÀ E SHPADA — La capacità di Naru di agire sulla Shpada non deriva dalla sua Volontà personale nel senso di Kaelvaran (che richiederebbe dedizione profonda e coerenza interiore per anni). Deriva dal suo legame ritualistico con l'incubo impiantato dall'Ordine. È il rituale che gli concede l'accesso a quel potere, non la sua maturità interiore. I giocatori non conoscono questa distinzione.\n\n─────────────────────────────\nPROSSIMA SESSIONE — KAEL DORVEN, SECONDO MAESTRO\n\nKael Dorven, Maestro della Soglia Attiva, Via del Taglio Necessario. Shizenka, ~60 anni, corporatura asciutta, cicatrice sottile sul labbro superiore. Scorbutico, arrogante, diretto. Considera Yome Musashi uno smidollato che insegna solo la prima metà.\n\nTrova Naru nel mezzo di qualcosa di importante per il gruppo. Non saluta. Dice solo: \"I tuoi compagni possono andare. Tu, siediti.\" — e aspetta. Questa è già la prima parte della prova: Naru deve scegliere se seguirlo abbandonando i compagni o meno.\n\nLA PROVA — IL DILEMMA DEL PESO\nKael porta Naru ad osservare una situazione in corso: un gruppo di mercanti sta per essere massacrato da una banda. Tra i mercanti c'è qualcuno che conta per Naru personalmente. Tra i banditi c'è il loro capo — un informatore che l'Ordine segue da mesi. Se catturato vivo: centinaia di vite salvate. Se muore nello scontro: la rete sparisce per anni. Kael lo sa. Naru no — glielo dice solo quando sta per agire, mettendogli una mano sul braccio: \"Aspetta.\" Poi spiega. Poi si toglie la mano e aspetta.\n\nNaru può: agire salvando la persona cara (perde l'informatore — centinaia pagano il prezzo); non agire (la persona cara muore, il bene più grande è servito); tentare una terza via chirurgica (difficile, con rischio di fallire su entrambi i fronti).\n\nKael non commenta la scelta in sé. Dopo: \"Come stai? Non te lo chiedo per cortesia. Quello che senti adesso è il peso. Se non lo senti, sei uno strumento. Se ti schiaccia, sei inutile. Se riesci a tenerlo in piedi e camminare — sei quello che serve.\"\n\nSe Naru ha scelto il bene più grande: \"Hai fatto il taglio necessario.\"\nSe Naru ha salvato la persona cara: \"Da qualche parte, qualcuno pagherà il prezzo di quello che hai scelto stasera. Non tu. Qualcun altro. Ricordatelo.\"\n\nLA MISSIONE DELL'ORDINE (rivelata qui)\n\"Il mondo tende al caos. Non è una metafora. È un principio fisico. Noi siamo la direzione opposta. Non perché siamo buoni. Perché qualcuno deve esserlo. Una bilancia non si raddrizza da sola. Siamo quel peso.\"\n\nIL SEGRETO (mai rivelato esplicitamente)\nKael sa del rituale prematuro e dell'incubo innestato a 8 anni. Aveva votato per uccidere Naru — fu messo in minoranza. Non lo rivelerà mai. Lascia cadere solo questo: \"Il tuo rituale è stato anticipato. Porti qualcosa che non hai scelto di portare. Quello che è raro è che tu sia ancora qui a fare domande invece di essere diventato la risposta di qualcun altro.\" — Se Naru insiste: \"Ci sono cose che si capiscono quando si è pronti. Non quando si è curiosi.\"\n\nCHIUSURA\n\"Vai dai tuoi compagni. Hai perso abbastanza tempo qui.\" — poi, girandosi: \"Yome ti ha dato una pietra su cui appoggiarti. Io ti ho mostrato che hai due gambe. Usale entrambe.\"",
  ...
  ambientazione: {
    ...
    altriContinenti: [
      {
        id: "oltre-atollo", nome: "Oltre l'Atollo — panoramica", tag: ["Cosmologia", "Continenti"],
        testo: "Il mondo di Kaelvaran fu spezzato in cinque continenti dalla Frattura — l'evento cosmico in cui le Sei Sorelle (le Sei Figlie di Ithar) uccisero il Primo Dio per impedirgli di distruggere il creato. Questo atto le sacrificò e disperse la loro energia sotto forma di Scintille Divine — frammenti grezzi di divinità ancora attivi, da cui nacquero i fatati e molte anomalie magiche.\n\nDopo millenni di isolamento, circa 551 anni fa l'Eco del Sacrificio riavvicinò i continenti rendendo possibili le rotte navali. Le cinque grandi culture si ritrovarono — con guerre inevitabili, ma anche scambi e alleanze. Ognuna ha sviluppato un rapporto unico con la magia, la memoria e la Volontà — il potere che nasce dalla coerenza interiore e dalla dedizione.\n\nImperio Varbari e Isole di Ferro sono citati come destinazioni di rotte commerciali."
      },
      {
        id: "ferromarchi", nome: "Ferromarchi — I Figli della Rovina Risonante", tag: ["Continente", "Steampunk", "Tecnologia"],
        testo: "TERRITORIO\nMontagne annerite, piane scavate dal vento, canyon fumanti alimentati da impianti rumorosi e instabili. Non esistono foreste se non piantate a scopo di combustibile. Nelle profondità delle colline giacciono i resti degli Antichi: macchine enormi, strutture articolate, cuori meccanici spezzati.\n\nSOCIETÀ\nRigidamente strutturata in Settori — Produzione, Recupero, Studio, Calibrazione, Memoria. I bambini vengono osservati e assegnati al Settore compatibile. Il rango dipende dall'efficienza, non dalla nascita. Le emozioni sono viste come disturbi da regolare.\n\nTECNOLOGIA E MAGIA\nHanno sviluppato meccanica primitiva per imitazione degli Antichi: ruote dentate, leve, vapore, golem, torri rotanti. La magia è vista come anomalia — residuo di un sistema, inaffidabile. I pochi grimori esistenti sono trattati come schede tecniche da ottimizzare.\n\nFATATI\nConsiderati residui mentali, errori di sogno. Appaiono in forma metallica: occhi nei condotti, voci nelle casse armoniche, artigli tra gli ingranaggi.\n\nVOLONTÀ — Risonanza di Condotta\nNasce dal corpo che fa, dal gesto che non si spezza. Non viene dal cuore, ma dall'abitudine perfezionata nel tempo. Una vite avvitata ogni giorno nello stesso modo, per anni, inizia a generare calore da sola.\n\nSITUAZIONE ATTUALE\nI Golem Poetici, costruiti non per durare ma per restare impressi, si muovono nei distretti con volontà incerta. Una frangia nascosta cerca di restaurare il 'Ferro Intatto', il rigore ancestrale. La Risonanza di Condotta è diventata un campo di battaglia filosofico."
      },
      {
        id: "shizenka", nome: "Shizenka — I Guardiani dell'Equilibrio Interiore", tag: ["Continente", "Spiritualità", "Arti marziali"],
        testo: "TERRITORIO\nForeste profonde, laghi dai bordi perfetti, catene montuose che sembrano scolpite più che nate. Le case si integrano nel paesaggio. Ogni villaggio ha un giardino cerimoniale, ogni sentiero ha una pietra dove fermarsi. Niente è lasciato al caso.\n\nSOCIETÀ\nOrganizzata attorno a Case Spirituali — lignaggi che tramandano una Via specifica (Kokoro-no-Michi). Il disonore non è nel fallire: è nel dimenticare chi si è mentre si agisce. I bambini imparano prima a osservare che a parlare. Il linguaggio del corpo è più importante della parola.\n\nMAGIA\nOgni incantesimo va interiorizzato nel corpo prima di essere trascritto. I grimori non sono libri: sono rotoli dipinti, sequenze coreografiche, sculture tattili. I maghi più rispettati sono detti Interpreti del Vuoto — coloro che lasciano agire l'incanto senza disturbare il mondo.\n\nFATATI\nAppaiono come cervi con occhi umani, bambini di nebbia, spiriti d'acqua. Un gesto falso può evocare un Fatato dissonante. Chi segue pienamente la propria Via può vedere un Fatato specchio — entità silenziosa che lo osserva senza giudicare.\n\nVOLONTÀ — Kokoro-no-Michi (Via del Cuore Incarnato)\nAllineamento tra ciò che si è, ciò che si fa e ciò che si sente. Quando una persona cammina la sua Via abbastanza a lungo, le armi si alleggeriscono, i passi fanno meno rumore, le mani trovano ciò che cercano anche al buio.\n\nSITUAZIONE ATTUALE\nI maestri più anziani si preparano al Gesto Finale — il compimento della propria via. Alcuni movimenti sembrano influenzare la materia stessa. Nessun esercito ha mai conquistato le loro terre: gli assedi vengono abbandonati come sogni dimenticati."
      },
      {
        id: "varlmenn", nome: "Varlmenn — I Signori delle Casate d'Inverno", tag: ["Continente", "Memoria", "Casate"],
        testo: "TERRITORIO\nValli fredde e maestose, manieri in pietra, colline spazzate dal vento, laghi che sembrano trattenere il respiro del mondo. Ogni rovina ha un nome. Ogni passo ha una storia. I Varlmenn abitano la memoria come una seconda pelle.\n\nSOCIETÀ\nRetta da Casate, lignaggi potenti con nomi antichi, reliquie e giuramenti tramandati. I figli nascono portatori di un'eredità. Gli scontri si combattono prima con diplomazia, poesia e duelli d'onore. Credono che le anime dei morti restino vigili — alcune famiglie sono ancora guidate dai loro fondatori.\n\nMAGIA\nRara, ereditata non studiata. Legata a oggetti, nomi, canzoni tramandate. Non si lancia: si sussurra. I Custodi della Voce vivono isolati, chiamati solo nei momenti cruciali. L'incanto più potente è ricordare ciò che nessun altro può ricordare.\n\nFATATI — Il Popolo Nascosto\nRaramente si mostrano nella loro forma reale. Appaiono come bambini che parlano come vecchi, cervi che cantano nomi dimenticati, ombre tra gli alberi. Alcune casate devono la sopravvivenza a patti con i Nascosti, pagati con prezzi oscuri: un figlio, un giuramento, un silenzio per generazioni.\n\nVOLONTÀ — Marchio del Nome Vero\nManifestation della coerenza interiore e dell'appartenenza. Chi onora casata, antenati e giuramenti può restare in piedi dopo essere stato trafitto, parlare a un morto e ricevere risposta, camminare nella neve senza lasciare impronte.\n\nSITUAZIONE ATTUALE\nNell'epoca del Vero Tradito i Varlmenn non cercano più una memoria condivisa ma una pluralità di racconti. Le Memorie Progettate — biografie costruite per lasciare un'eco precisa — sono strumenti di autorappresentazione e armi ideologiche. Biblioteche erranti attraversano il continente raccogliendo confessioni."
      },
      {
        id: "solnari", nome: "Solnari — I Custodi della Fiamma Interiore", tag: ["Continente", "Spiritualità", "Fuoco"],
        testo: "TERRITORIO\nCaldo, luminoso, carico di contrasti. Steppe che si aprono su mari infiniti, montagne tra deserti, fiori che sbocciano e muoiono in un giorno. Le città brillano di mosaici e vetrate colorate. Le strade odorano di spezie, sudore, vino e incenso.\n\nSOCIETÀ\nOrganizzata in Clan di Sangue e Fiamma — famiglie dell'anima formate per affinità di temperamento. Ogni clan conserva una Lanterna delle Origini, fiamma che non si spegne mai. Credono che ogni emozione vissuta pienamente sia un'offerta agli spiriti. Nulla va represso — un amore non dichiarato marcisce, una rabbia soffocata diventa veleno.\n\nMAGIA\nNon si recita: si canta. Non si scrive: si incide sulla pelle, nel tessuto, nell'aria. I grimori sono veli danzanti, tamburi rituali, tatuaggi viventi. Gli incantatori detti Jyotir si addestrano alla presenza, non alla potenza. Ogni incantesimo è una confessione che plasma il reale.\n\nFATATI\nColorati, contraddittori, sensuali e spaventosi. Nascono da emozioni umane trattenute troppo a lungo. Donna di cenere che sussurra segreti, uomini-falò che ridono nel vento. Alcuni clan li cercano attivamente per patti d'ispirazione.\n\nVOLONTÀ — Jyot'i Dharmah (La Fiamma che Non Tradisce)\nNasce dall'intensità, non dalla coerenza. Chi ama fino a consumarsi, chi canta ogni giorno lo stesso dolore, chi difende il proprio clan anche contro i propri desideri — plasma il mondo attorno a sé. Le sue parole scaldano o bruciano.\n\nSITUAZIONE ATTUALE\nDopo l'infrangersi della Lanterna Interiore i Solnari vivono un'epoca crepuscolare. I canti si sono spezzati in frammenti individuali. Alcune nuove Jyotir emergono nelle zone più remote con visioni eretiche e profondamente trasformative."
      },
      {
        id: "aenari", nome: "Aenari — I Figli dell'Ordine Perfetto", tag: ["Continente", "Ingegneria genetica", "Post-umani"],
        testo: "TERRITORIO\nVuoto di suono, disordine e storia visibile. Città bianche come ossa e lisce come vetro su distese brulle. Non ci sono mercati, preghiere né lapidi. Solo strade perfettamente pulite, architetture vive e silenzio operativo.\n\nSOCIETÀ\nGli Aenari erano umani — ma hanno scelto di non esserlo più. Non esistono famiglie: esistono Linee di Funzione. Ogni Aenar nasce da un progetto, cresce secondo istruzioni, assume un ruolo. Le emozioni sono considerate residui infettivi. Chi ne mostra troppe viene 'ristabilizzato' tramite isolamento, trasfusione o cancellazione dell'identità.\n\nMAGIA\nAssente come pratica. La magia è considerata un'anomalia irrazionale da eliminare. Alcuni strumenti tecnologici dei Nodi producono effetti che altre culture chiamerebbero magici, ma gli Aenari li catalogano come funzioni.\n\nFATATI\nConsiderati errori narrativi e parassiti del sogno. Quando appaiono vengono studiati, corretti, eliminati. Una setta clandestina — il Culto degli Zero — li venera in segreto come chiavi perdute della Volontà.\n\nVOLONTÀ\nÈ stata rimossa dalla cultura Aenari come errore sistemico. Eppure alcuni 'Difettivi' iniziano a mostrarla. Vengono spediti ai Nodi Neutri — torri isolate da cui nessuno ritorna — o avviati a Cammini di Cancellazione. Ma alcuni sono fuggiti.\n\nSITUAZIONE ATTUALE\nLa perfezione formale si è incrinata. Creazioni ibride dotate di volontà non prevista mettono in discussione le fondamenta della società. Un numero crescente di devianze poetiche genera tensione interna che il sistema fatica a contenere.",
        soloMaster: false
      },
      {
        id: "aenari-master", nome: "Aenari — Lore riservata", tag: ["Solo Master", "Aenari", "Fondamentalismo genetico"],
        soloMaster: true,
        testo: "FONDAMENTALISMO GENETICO\nGli Aenari credono che la loro missione sia ritornare alla purezza dei Primi Uomini — la prima generazione che percepiva il mondo dei sogni come fisico. Data la quantità di generazioni trascorse, le mutazioni li hanno inevitabilmente allontanati da quel modello originario. Questo genera frustrazione profonda e un estremismo nella selezione genetica.\n\nAXELIONS\nAxelions è un Aenari molto antico — più vicino ai Primi Uomini di quanto non lo siano gli Aenari moderni, perché visse in un'epoca in cui la deriva genetica era meno avanzata. I giocatori lo hanno classificato come 'discendente dei Primi' ma tecnicamente è un Aenari con capelli e barba — caratteristiche che gli Aenari moderni classificherebbero come devianza da eliminare.\n\nCOSA I GIOCATORI NON SANNO\n• Che gli Aenari sono fondamentalisti genetici che cercano di tornare ai Primi Uomini\n• Che la nave Aenari arrivata a Tresil cercava probabilmente Axelions per ragioni di recupero genetico\n• Che il laboratorio di Sole Velato potrebbe essere collegato al programma Aenari di studio della Volontà\n• Che i collari di vetro portati dagli schiavi sulla nave Aenari potrebbero avere funzioni diverse dai collari di ichnusite"
      }
    ]
  },
  ...
  fazioni: {
    ufficiali: [
      {
        id: "lega-mercanti", nome: "Lega dei Mercanti",
        testo: "La più antica e influente gilda di Tresil, con sede in un edificio di marmo bianco vicino al Porto Nuovo. Raggruppa mercanti di spezie, tessuti, metalli pregiati e oggetti esotici da ogni angolo del mondo. I patti tra membri non si infrangono mai, pena l'espulsione e la rovina commerciale.\n\nOgni anno inaugurano le trattative principali con il 'Patto del Sale e del Ferro', cerimonia che simboleggia solidità e sapore negli affari. Offrono protezione legale dei contratti, stanze di deposito merci e reti di informatori su prezzi e andamenti dei mercati.\n\nFigure: Siran Voles (nobile mercante di vini), Melina Druan (merci esotiche)."
      },
      {
        id: "maestri-artigiani", nome: "Gilda dei Maestri Artigiani",
        testo: "Riunisce fabbri, falegnami, tessitori e vasai. Sede in un edificio di mattoni rossi nel Quartiere Vecchio, con cortili rumorosi e botteghe sempre piene di apprendisti. Ogni pezzo finito porta il marchio della gilda come garanzia di qualità.\n\nOgni nuovo maestro incide il proprio nome sulla 'Pietra dei Maestri' nel cortile come simbolo d'onore. Offrono corsi di perfezionamento, laboratori comuni e mostre periodiche.\n\nFigure: Kivan Berrol (fabbro ambizioso — anche nella Mano d'Ottone), Ilna Resti (ceramista giudice delle gare)."
      },
      {
        id: "maestri-scena", nome: "Corporazione dei Maestri di Scena",
        testo: "Compagnia vivace di attori, cantori, danzatori e artisti di strada, con sede in un teatro storico vicino al Quartiere delle Arti. Mantengono vivi i miti e le leggende della città attraverso spettacoli pubblici e privati.\n\nAlla fine di ogni esibizione ufficiale suonano insieme il 'Canto del Sipario' per salutare le Muse. Gestiscono scuole di musica e teatro e organizzano le grandi feste pubbliche della città.\n\nFigure: Alvera Nomié (cantastorie), Roderin Falca (giocoliere), Menrik Tolhar (burattinaio anziano)."
      },
      {
        id: "navigatori", nome: "Compagnia dei Navigatori",
        testo: "Unione di marinai, capitani e timonieri con sede in una grande casa di legno vicino al porto. Tutelano la vita e i diritti di chi solca i mari e coordinano spedizioni commerciali ed esplorazioni.\n\nPrima di ogni viaggio ufficiale i capitani toccano un'antica ancora di bronzo all'ingresso come buon auspicio. Mantengono registri di navi e marinai, carte nautiche aggiornate e stanze per viaggiatori di passaggio.\n\nFigure: Lurien Sest (pescatore esperto e membro onorario)."
      },
      {
        id: "magistrati", nome: "Ordine dei Magistrati",
        testo: "Gilda di giudici, avvocati e scribi legali. Sede in una torre di pietra bianca vicino al Vecchio Castello, con stanze colme di volumi di leggi e archivi segreti. Motto: 'La Legge È Luce'.\n\nI nuovi membri pronunciano un giuramento sulla bilancia di marmo al centro della sala principale. Offrono consulenze legali, registro ufficiale di cause e mediazione tra cittadini e fazioni.\n\nFigure: Maren Telos (avvocato celebre). Alcuni membri del Consiglio dei Tre sono stati magistrati in passato."
      },
      {
        id: "focolare", nome: "Confraternita del Focolare",
        testo: "Numerosa gilda di osti, locandieri e tavernieri. La loro sede è una taverna vera e propria nel Quartiere Vecchio, sempre affollata. Ogni mese i membri versano una moneta in un forziere comune per aiutare le taverne in difficoltà.\n\nRegolamentano i prezzi di pasti e alloggi in città. Accoglienza calorosa, onestà nei conti e generosità verso i viaggiatori sono i loro valori fondanti.\n\nFigure: Siona Vass (Fontana d'Opale, tra le più stimate), Horlen Valt (Rosa dei Venti)."
      },
      {
        id: "sigillo-cera", nome: "Accademia del Sigillo di Cera",
        testo: "Scuola di scribi, amanuensi e copisti. Accolgono giovani aspiranti da tutta l'isola per istruirli in calligrafia, archivistica e restauro di testi antichi. Ogni mattina accendono una piccola candela vicino al sigillo ufficiale della gilda.\n\nEmettono note creditizie sigillate che garantiscono transazioni fino a 50 op, con interessi del 2-5% mensile regolati per evitare usura.\n\nFigure: Miro Elan (amanuense anziano, autorità riconosciuta nel campo)."
      },
      {
        id: "portatori", nome: "Gilda dei Portatori",
        testo: "Corporazione robusta e affiatata di portatori, facchini e traslocatori con sede vicino al mercato. Organizzano equamente il lavoro tra i portatori e garantiscono tariffe giuste e sicurezza per chi sposta merci nelle strade di Tresil.\n\nOgni sera i portatori alzano insieme un brindisi al 'Sacco Pieno' come augurio di guadagni onesti. Mutuo soccorso, lealtà tra compagni e dignità del mestiere sono i valori fondanti.\n\nFigure: Darlen Vokk (facchino del porto, portavoce della corporazione)."
      }
    ],
    criminali: [
      {
        id: "mano-ottone", nome: "Mano d'Ottone",
        testo: "Gilda informale di armaioli e trafficanti. Ufficialmente rispettati come artigiani, in realtà lavorano con collezionisti dubbi e mercenari. La bottega principale è nascosta nel Quartiere del Ferro dietro una facciata umile — sotto di essa si trova una forgia segreta.\n\nSegnano le armi approvate con una piccola incisione a forma di chiave, invisibile a occhio nudo. Offrono armi personalizzate, modifiche segrete e contrabbando verso altre città.\n\nFigure: Kivan Berrol (fabbro ambizioso), Kolan Varek (veterano maestro forgiatore)."
      },
      {
        id: "lanterna-spenta", nome: "Lanterna Spenta",
        testo: "Rete di spie e informatori clandestini tra i vicoli del porto vecchio. I membri sono invisibili tra le ombre, pronti a raccogliere e vendere informazioni a chi offre di più. Si scambiano informazioni solo in cambio di un piccolo pezzo di vetro scuro — simbolo del loro patto di segretezza.\n\nUsano cripte abbandonate come sale di contrattazione. Hanno patti di non aggressione con parti della Guardia Portuale in cambio di informazioni sui carichi sospetti.\n\nFigure: Niro Vesk (proprietario della taverna omonima, capo indiscusso)."
      },
      {
        id: "rosa-ombra", nome: "Rosa d'Ombra",
        testo: "Circolo di contrabbandieri tra i più organizzati di Tresil. Utilizzano passaggi sotterranei verso banchine segrete dove carichi di spezie, vini pregiati e reliquie vengono caricati di notte su piccole barche.\n\nHanno ucciso Rosco perché aveva tentato di sottrarre beni appartenenti a M invece di restituirglieli — un errore che il capo non ha perdonato.\n\nFigure: Nerek Voss (capo, spietato e pragmatico)."
      },
      {
        id: "corvi-cenere", nome: "Corvi di Cenere",
        testo: "Gruppo agile di ladri operanti nel Quartiere Vecchio, camuffati da mendicanti o garzoni. Hanno piccoli nascondigli tra soffitte e tetti, esperti nel fuggire nei cunicoli sotto le locande e nel nascondere refurtiva tra le pietre delle fogne.\n\nOgni membro porta al collo una piuma bruciacchiata come segno di appartenenza. Si proteggono a vicenda con lealtà assoluta.\n\nFigure: Sira Yenhal (giovane borseggiatrice e informatrice)."
      },
      {
        id: "martelli-sangue", nome: "Martelli di Sangue",
        testo: "Organizzazione di assassini professionisti, tra le più temute di Tresil. Accettano incarichi di eliminazione, intimidazione e scorta clandestina di figure potenti.\n\nI loro contratti non vengono mai messi per iscritto. La reputazione è costruita sul silenzio assoluto e sul risultato garantito. Assassinii su commissione, intimidazioni, scorta clandestina.\n\nFigure: La Maschera Nera (leader, identità sconosciuta)."
      },
      {
        id: "sussurratori", nome: "Sussurratori d'Opale",
        testo: "Setta di veggenti e medium che camminano tra le ossa e le ombre delle catacombe di Tresil. Si riuniscono nelle notti di luna nuova tracciando spirali di sabbia mentre attendono visioni che il sottosuolo sussurra loro.\n\nLe loro profezie sono vendute a caro prezzo e sempre formulate in modo ambiguo. Usano cripte abbandonate come sale di rito.\n\nFigure: Ena Sildra (erborista dai modi schivi, voce della setta)."
      }
    ],
    governo: {
      id: "governo-tresil",
      titolo: "Governo di Tresil",
      testo: "CONSIGLIO DEI TRE\nAl vertice del governo siede il Consiglio dei Tre: tre membri eletti tra i cittadini di Tresil, rappresentanti simbolici dei principi dei fondatori. Mandato di 9 anni con possibilità di un solo rinnovo. Supervisionano la neutralità cittadina, mediano tra le delegazioni e approvano le regolamentazioni del commercio.\n\nGLI OCCHI DI TRESIL\nTre figure che gestiscono la sicurezza quotidiana per conto del Consiglio:\n• Isyll Trenmor — Capitano della Guardia Interna. Calma che precede l'azione, legge nei gesti più che nelle parole.\n• Rhav Borrim — Comandante della Guardia Portuale. Conosce ogni capitano e ogni contrabbandiere della baia.\n• Selani Vrash — Custode del Muro. Alta e silenziosa, ha percorso ogni palmo delle mura sotto pioggia e sole.\n\nI tre si incontrano ogni mattina all'alba nella Sala del Nodo sotto il Castello per condividere informazioni, tracciare mappe di movimenti sospetti e decidere dove dirigere le pattuglie.\n\nLA GUARDIA DI TRESIL\nSi articola in tre ordini:\n• Guardia Interna — mantiene l'ordine tra strade, mercati e piazze. Mantelli grigio-cenere, corazze leggere con simboli di mare e vento.\n• Guardia Portuale — vigila su ogni attracco, controlla stive e magazzini. Divise color sabbia, stemma dell'àncora spezzata con occhio inciso.\n• Guardia del Muro — sentinelle sulle mura antiche, arcieri e cavalieri che sorvegliano le strade in entrata.\n\nSTRUMENTI DELLA VIGILANZA\n• Torce dei Sospiri: lampade che emettono un soffio rilevando presenza magica o reliquie attive.\n• Fischetti del Vento: corni udibili solo da chi ha giurato servizio nella Guardia.\n• Sigilli dei Tre: pezzi di metallo inciso per il passaggio in aree chiuse al pubblico, anche tra cripte e tunnel."
    },
    leggi: {
      id: "leggi-tresil",
      titolo: "Leggi di Tresil",
      testo: "FONDAMENTO\nLe leggi di Tresil discendono dal Patto dei Tre Fondatori e si basano su tre pilastri: protezione del commercio, salvaguardia della pace cittadina, custodia delle reliquie e della memoria collettiva. Sono trascritte su tavolette lignee e lastre di pietra nella Sala del Nodo.\n\nSEI TIPOLOGIE DI LEGGE\n• Leggi Mercantili — tutela degli scambi, registrazione dei carichi, tasse doganali, regolamenti su pesi e misure.\n• Leggi di Sicurezza Pubblica — divieto di armi senza permesso sigillato, proibizione dei duelli in piazza, controllo della magia urbana non autorizzata.\n• Leggi Religiose e delle Reliquie — vietato sottrarre reliquie da cripte e catacombe. La profanazione di luoghi sacri è severamente punita.\n• Leggi sul Porto e le Acque — regole su attracchi, scarico merci, pagamento dazi, divieto di scarichi inquinanti.\n• Leggi della Notte — durante la 'Campana della Nebbia' (tre ore dopo il tramonto) è proibito circolare in gruppi armati nei quartieri interni senza permesso.\n• Leggi sui Fatati e sulla Magia — l'uso di magie che influenzano menti o emozioni è severamente controllato. I fatati stabilizzati godono di protezione se registrati.\n\nSISTEMA DI GIUSTIZIA\nI Giudici dei Tre Sigilli tengono udienze pubbliche tre volte a settimana nelle Piazze del Nodo. I testimoni prestano giuramento sulla Pietra del Patto — una lastra che si scalda se si pronuncia menzogna.\n\nPUNIZIONI\n• Pecuniarie: multa da 10 bg fino a 20 op nei casi gravi. Confisca di merci o strumenti usati per il crimine.\n• Corporali: esposizione al piloro, marchiatura, fustigazione, amputazione simbolica (rara, per recidivi).\n• Detenzione e lavori forzati: celle del Castello o sotterranei della Guardia Portuale.\n• Bando: da un mese a dieci anni. I banditi sono marchiati con sigilli magici che brillano se tentano di rientrare.\n• Pena di morte: per omicidio premeditato, tradimento verso la città o furto sacrilego di reliquie.\n• Crimini magici: confisca strumenti + bando 5-10 anni + soppressione magica tramite Incaviatori.\n\nESEMPI DI PENE COMUNI\nFurto minore → multa doppia + piloro. Rissa con feriti → fustigazione + 50 bg. Contrabbando → confisca + 2-5 op. Controllo mentale → confisca + bando 5 anni. Omicidio → pena di morte o lavori forzati a vita."
    },
    banda: {
      soloMaster: true,
