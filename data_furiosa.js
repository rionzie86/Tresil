...
const FURIOSA_DATA = {
  ...
  meta: {
    ...
    dataAttuale: "Quattro sessioni giocate al tavolo — il party ha appena lasciato Fonte Verde dopo il rituale e le visioni di Furiosa",
    prossimaDestinazione: "Da Fonte Verde, sulle tracce di Ados e della verità sulla donna sfigurata incontrata durante il rituale"
  },
  ...
  sessioni: [
    ...
    },
    {
      ...
      luogo: "Villaggio di Pozzprofond → Fonte Verde",
      riassunto: "11 settembre 2026 (fuori gioco). Il party lascia Tresil all'alba con quattro cavalli inviati da Whilliam; lungo la strada Zoraya impara le basi della cavalcata, mentre le condizioni di Karl peggiorano (febbre, ferita infetta). Arrivati a Pozzprofond, cercano Berer: la sua tomba, ai piedi del castagno, risulta profanata di recente. Il nipote di Berer e suo padre (fratello di Berer) confermano di non conoscere Ados, ma indicano Fonte Verde, a ovest, come il luogo dove si troverebbe — sconsigliando vivamente di andarci. Il gruppo decide di nascondere i frammenti in locanda prima di procedere.\n\nKarl ha un crollo psicologico (attacco di panico, percezioni alterate, tentativo di allontanarsi da solo); dopo un inseguimento notturno sotto la pioggia, Rei lo ferma con la sua catena e il gruppo si riunisce.\n\nA Fonte Verde, di notte, il party si imbatte in una processione silenziosa di villici con candele attorno a una casa con gli scuroni chiusi, e in una decina di cadaveri di ragazze con la gola tagliata. Dentro, un \"Gran Sacerdote\" sgozza una donna in un rituale; compare una donna dalla pelle cadente e un osso visibile allo zigomo, con al collo un anello di metallo incastonato di frammenti rosso sangue. Guardie dagli occhi bianchi intervengono, la casa prende fuoco nel caos dello scontro. Karl strappa l'anello dal collo della donna (che gli spezza due costole prima che Rei le reciso la mano), poi vi incastra i frammenti del party. Tutto si spegne: seguono quattro visioni separate — una per PG — di un'entità che si presenta come Furiosa, che chiede a ciascuno di \"ricomporla\" e offre un dono diverso, calibrato sul desiderio di ciascuno (vedi le pagine Punto di Vista di ogni PG per il dettaglio soggettivo).",
      eventiChiave: [
        "Partenza da Tresil con quattro cavalli inviati da Whilliam; Zoraya impara a cavalcare",
        "Arrivo a Pozzprofond; tomba di Berer trovata profanata",
        ...
        "Karl strappa l'anello alla donna; Rei le recide la mano per liberarlo",
  ...
  thread: {
    sviluppo: [
      ...
      { id: "th-25", testo: "Se Lilglia (la donna sfigurata, non-morta) sia sopravvissuta all'incendio di Fonte Verde nonostante la mano recisa da Rei, o sia stata distrutta — i PG non sanno ancora che sia lei." },
      { id: "th-26", testo: "Cosa significhi la chiave nella scarsella nella visione di Karl a Fonte Verde — un dettaglio assente dalla sua scheda/backstory originale sulla notte in cui morirono Claudia e Hetel." },
