...
const FURIOSA_DATA = {
  ...
  meta: {
    ...
    dataAttuale: "Giorno 13 del terzo mese, mattina — il party ha appena affrontato e ucciso Lilglia nel villaggio dei villici presso Fonte Verde, e si è confrontato sinceramente sulle rispettive visioni di Furiosa",
    prossimaDestinazione: "Verso Pozzprofond, per recuperare i due cavalli lasciati lì, e poi verso Tresil — decisione presa al tavolo a fine Sessione 5, dettagli ancora da giocare"
  },
  ...
  sezioni: [
    ...
    { id: "libro",      label: "Sviluppo Libro", icona: "✎" }
  ],

  prepProssimaSessione: {
    titolo: "Viaggio di ritorno a Tresil",
    sottotitolo: "Chiacchierata conoscitiva — scaletta DM (Blocco 6, aggiunta 20 settembre 2026)",
    nota: "Scaletta di supporto per la seduta del viaggio di ritorno da Pozzprofond a Tresil dopo gli eventi di Fonte Verde/villaggio dei villici (Sessione 5). Pensata per dare spazio a una lunga chiacchierata conoscitiva tra i quattro personaggi. Le caselle si spuntano e restano salvate su questo dispositivo. Vedi anche la sezione \"Sviluppo Libro\" per il dettaglio caratteriale di ciascun personaggio da cui questi spunti sono derivati.",
    eventi: [
  ...
  caratterizzazioneLibro: {
    zoraya: {
      titolo: "Zoraya Al Khmani — l'impulso che agisce prima di pensare",
      corpo: "<p><strong>Nucleo del personaggio.</strong> Zoraya non media, non argomenta, non aspetta: quando percepisce un'ingiustizia agisce, fisicamente e subito. È il prodotto di un'infanzia passata nei vicoli di un porto — a badare a se stessa mentre la famiglia lavorava, a imparare la lotta dal fratello maggiore \"per tenerla fuori dai guai\", a intervenire per chi le sembrava in svantaggio. Da lì porta un rifiuto viscerale di ogni gerarchia che si autogiustifichi: non tollera l'idea che qualcuno valga meno solo per dove è nato. Per lei \"certe cose sono così e basta\" — non ha bisogno di elaborare oltre.</p><p><strong>Come si muove e come parla.</strong> Fisica, diretta, spesso impulsiva fino all'incoscienza: nella Sessione 3 si getta a corpo morto contro un nemico già a terra per finirlo a calci, ripetendo i colpi \"fino a che non sta giù\". Dopo la violenza il suo corpo cede — vomita spesso e ripetutamente (lei stessa lo nota con imbarazzo: \"non ho smesso di vomitare perché non c'ho più niente\") — segno che l'azione le viene più facile della sua elaborazione. In gruppo alleggerisce la tensione con battute pratiche, quasi materne verso gli altri, ma senza mai perdere la concretezza: è il tipo che agisce e poi, solo dopo, fa i conti con quello che ha fatto.</p><p><strong>Voce interiore / valori.</strong> La sua storia personale è tutta intorno al tema della verità: ha rifiutato pubblicamente un intero sistema di potere cantando, davanti a una folla, l'ingiustizia della gerarchia delle \"vie\" — un atto di ribellione totale, pubblico, irreversibile, compiuto da sola contro un'istituzione enorme. Non le importa delle conseguenze quando sente di avere ragione.</p><p><strong>Legame con Furiosa.</strong> È la più \"vicina\" alla dea fin dall'inizio (sogni ricorrenti di una donna danzante coperta di sangue, molto prima degli eventi di gioco). Furiosa le chiede di far ardere \"la fiamma della vera verità\" fino a renderla ineluttabile. Il potere che ottiene ha un costo fisico devastante: dopo averlo usato smette quasi di respirare, \"fuma\" dal corpo, ha convulsioni — il prezzo pagato da un corpo che va sempre oltre il proprio limite, esattamente come fa il suo carattere.</p><p><strong>Frase-chiave.</strong> Di fronte al mostro in cui è diventata Lilglia non usa la lama, le tiene il volto tra le mani e le grida la verità in faccia — \"Tu sei morta, sei un cadavere e stai mangiando cadaveri\" — prima ancora che Rei la finisca. La verità come arma, prima ancora della violenza.</p>"
    },
    nikla: {
      titolo: "Nikla Kruv — l'osservatrice che si fida solo dopo aver verificato",
      corpo: "<p><strong>Nucleo del personaggio.</strong> Orfana cresciuta nelle fogne di Ferrath, Nikla ha imparato prestissimo che il mondo si divide in due: giusto o sbagliato, sicuro o pericoloso, di cui fidarsi o da cui guardarsi. È una visione dicotomica, quasi rigida, ma non è freddezza — è un meccanismo di sopravvivenza. Preferisce ascoltare e raccogliere informazioni piuttosto che esporsi.</p><p><strong>Come si muove e come parla.</strong> Metodica anche in combattimento: i suoi incantesimi non sono mai casuali, mira sempre a un punto preciso con un obiettivo tattico chiaro. Ma la sua compostezza si sgretola davanti a ciò che non capisce: quando Rei ha le convulsioni, Nikla ammette apertamente il proprio smarrimento (\"non ho la minima idea di che cosa fare, sono un po' in panico\") — lucidissima quando ha il controllo, genuinamente spaventata quando non ce l'ha. Nota comica ricorrente: è una pessima cuoca, brucia tutto quello che tocca in cucina.</p><p><strong>Voce interiore / valori.</strong> \"Una volta guadagnata la sua fiducia, è leale per sempre\": non si affeziona in fretta, ma quando lo fa è un legame totale, senza mezze misure — coerente con la sua visione binaria del mondo. Non parla di sé se non costretta.</p><p><strong>Legame con Furiosa.</strong> Il suo rapporto con la dea è il più inquietante e ambiguo dei quattro: le viene promessa conoscenza — accesso a un \"codice sorgente\" della realtà — proprio mentre sta morendo dissanguata in scena. <span style='opacity:.75'>[Solo Master] Dentro di lei è imprigionato un incubo, che usa il suo stesso incantesimo per manifestarsi (dita, mani, un volto che le emergono dal corpo) — informazione mai da rivelare ai giocatori. Ottimo elemento di tensione drammatica per il libro: il personaggio più controllato del gruppo porta dentro di sé qualcosa che nemmeno lei controlla.</span></p><p><strong>Frase-chiave.</strong> Il momento in cui, ferita quasi a morte, decide comunque di lanciare l'incantesimo di rigenerazione chiedendosi \"che valore avesse l'inchiostro rimasto\" — \"morta per morta\". La sua razionalità che cede, per una volta, alla disperazione pura.</p>"
    },
    rei: {
      titolo: "Rei — l'assassina che sta imparando a scegliere",
      corpo: "<p><strong>Nucleo del personaggio.</strong> È il personaggio con l'arco più esplicito di tutti, grazie al diario in prima persona della sua giocatrice: uccidere per Rei è sempre stato un lavoro, un compito eseguito senza volontà propria, insegnato da un \"vecchio maestro\" mai meglio precisato. Il cuore della sua storia in questa fase è il passaggio — lento, ancora incompiuto — dall'eseguire ordini al scegliere: \"Voglio scegliere perché so cosa volere, desiderare, non perché eseguo ordini o seguo un istinto primario.\"</p><p><strong>Come si muove e come parla (o non parla).</strong> In scena è essenziale, quasi laconica — agisce, uccide, osserva. Ma la sua voce interiore (il diario) è l'esatto opposto: densa, lirica, piena di immagini fisiche e sensoriali (\"la morte è come un elastico nella mia mente\"). Questo scarto tra l'esteriorità muta e l'interiorità straripante è il tratto più utile per il romanzo: Rei va scritta soprattutto dal di dentro. Guarda gli altri con un misto di distacco clinico e invidia sincera per chi riesce a provare disgusto per la violenza.</p><p><strong>Voce interiore / valori.</strong> Diffida per riflesso di ogni legame (\"non le voglio, o le voglio? Non mi sento terribilmente sola da quando sono rinata?\") ma finisce comunque per accettare la compagnia di Nikla e Zoraya. Teme un'entità o organizzazione chiamata \"la Madre Nera\", mai spiegata ma capace di farle scattare un allarme immediato.</p><p><strong>Legame con Furiosa.</strong> Furiosa le si presenta come qualcosa \"nato da un'ombra, sfruttata\", in lotta per la libertà dalle catene — parallelo quasi esplicito con la condizione di Rei stessa. Le sue armi diventano estensioni letterali di questo legame: assorbono il sangue versato, diventano più pesanti quanto più uccidono.</p><p><strong>Frase-chiave.</strong> Il gesto finale su Lilglia — non un colpo di rabbia, ma un riconoscimento lucido: la chiama per nome, decide \"questa deve morire, è morta\", e solo allora agisce. Lo stesso schema di sempre, ma per la prima volta preceduto da una scelta consapevole, non da un ordine o un riflesso.</p>"
    },
    karl: {
      titolo: "Karl Brenner — il lutto trasformato in dovere di proteggere",
      corpo: "<p><strong>Nucleo del personaggio.</strong> Karl entra in scena già distrutto: guardia cittadina, marito e padre, ha perso moglie e figlia (Claudia ed Hetel) uccise da briganti mentre lui era di ronda — non è riuscito a salvarle, e questo è il trauma fondante di tutto ciò che fa ora. Prima della tragedia era già un uomo poco espansivo, cresciuto in una famiglia pragmatica e poco affettuosa (\"stringi i denti e tieni duro\"): la perdita non lo ha reso un'altra persona, ha semplicemente scavato più a fondo un solco già presente.</p><p><strong>Come si muove e come parla.</strong> Parla poco e quasi sempre per decidere qualcosa, non per commentare (\"per me deve andare giù. Non ho intenzione di ucciderlo però\" — nota la distinzione morale che si impone anche in pieno scontro). A differenza del padre, riconosce con lucidità le proprie emozioni mentre le prova — non le reprime per davvero, semplicemente non le comunica. Quando il trauma lo travolge non lo elabora a parole: vomita, si isola, esce di scena fisicamente.</p><p><strong>Voce interiore / valori.</strong> Il suo arco è la trasformazione del senso di colpa in azione concreta: non potendo aver salvato Claudia ed Hetel, protegge con ferocia chiunque gli sia vicino ora. Nei momenti in cui aiuta qualcuno a sopravvivere è lucido e \"non soffre\": è quasi l'unico momento in cui il suo dolore tace.</p><p><strong>Legame con Furiosa.</strong> La dea non gli offre potere fine a se stesso, ma un patto esplicito sul lutto: gli mostra ripetutamente scene in cui non riesce comunque a salvare Claudia ed Hetel, per fargli accettare che \"il passato è passato\" — e gli propone in cambio la possibilità che nessun altro debba mai più perdere chi ama, dandogli il potere di impedire la morte di chi vuole vivere (\"dieci unghie, dieci vite puoi ancorare al corpo\").</p><p><strong>Frase-chiave.</strong> La definizione che lui stesso dà del proprio rapporto con la dea: \"la furia del voler sopravvivere, lottare con le unghie e con i denti\". Non eroismo astratto: sopravvivenza cocciuta, applicata agli altri perché non è riuscito ad applicarla a chi amava.</p>"
    },
    sintesiGruppo: {
      titolo: "Nota sulla dinamica di gruppo",
      corpo: "<p>I quattro condividono una struttura tematica comune: ognuno arriva da una forma di impotenza subita (Zoraya contro un sistema che nega la verità, Nikla contro l'abbandono e l'ignoto dentro di sé, Rei contro un addestramento che le ha tolto la volontà, Karl contro una notte che non è riuscito a impedire) e Furiosa offre a ciascuno, in lingua diversa, la stessa cosa: la possibilità di smettere di subire e iniziare a scegliere. È il filo rosso che tiene insieme quattro archi molto diversi tra loro e che può funzionare da spina dorsale tematica per il libro.</p><p>Il gruppo, dopo la Sessione 5, si è consolidato esplicitamente come famiglia scelta (\"decidono di restare uniti come gruppo scelto da Furiosa\") — un punto di svolta narrativo naturale per chiudere un primo \"atto\" del romanzo e aprirne uno nuovo.</p>"
    }
  },
  ...
  personaggi: {
    pg: [
      ...
      },
      {
        ...
        loreMaster: "Kaf e Theris erano due degli otto membri del vecchio gruppo di avventurieri di Ados, gli \"Otto Raggi di Kesper\" (vedi Lore Segreta) — entrambi ora morti in scena, entrambi per mano di Rei. Il frammento fuso Kaf+Theris è ora in possesso di Rei. Sessione 3: Rei finisce uno dei tre non-morti spappolandogli la testa con un calderone, poi vomita per lo shock. Elementi ancora da sviluppare: chi/cosa è \"la Madre Nera\" che Rei teme possa averla trovata; chi è il suo \"vecchio maestro\". **Verificato (Sessione 3, righe 217-222 della trascrizione):** durante il blackout/convulsione di Rei subito dopo il primo scontro alla Rosa Storta (mentre Nikla la teneva ferma), il Master ha effettivamente narrato che parlava con due voci distinte contemporaneamente, di tono diverso (una quasi felice, l'altra cupa) — dettaglio autentico, non un errore.\n\nSessione 4 (Fonte Verde): durante il rituale, Rei combatte evitando per quanto possibile di usare lame sulla gola altrui (la solita paura delle convulsioni), viene sommersa e ferita più volte, aiuta a raccogliere i frammenti e ha una propria visione di Furiosa, che le chiede di \"rinascere completa\" e le offre \"la libertà di essere completi\" — la stessa formula già annotata come battuta di Furiosa nel primo contatto (vedi \"Furiosa — la Divinità\"). Rei le tende la mano nella visione.\n\nSessione 5: Furiosa le mostra come le sue armi (\"tridenti\"/anima rossa) siano percepibili entro 9 metri e richiamabili a sé, e le indica emozioni da \"coltivare\" (gioia, disgusto, fierezza, tristezza-come-appartenenza); la chiama sua campionessa. Salta a cavalcioni sul collo di Lilglia (dopo che Zoraya le impone la verità) e la decapita. Al mattino, durante il confronto sincero del gruppo, Zoraya e Nikla le ricordano di aver parlato con due voci diverse durante una convulsione precedente alla locanda di Whilliam — episodio che la trascrizione della Sessione 3 conferma essere realmente accaduto (vedi sopra).",
        note: ""
      }
    ],
    png: [
    ...
    membri: [
      {
        ...
        testo: "Scaltro e forte, era il leader informale del gruppo. Marito di Lilglia, morta di recente a 82 anni. Whilliam ha confermato che è lui il mandante dei tre uomini che hanno assalito la Rosa Storta, e ha implorato il party di andare a cercarlo e, se possibile, salvarlo — ricordando che \"è una brava persona, che illuminava gli altri\". A Pozzprofond, il fratello di Berer ha indicato ai PG Fonte Verde, a ovest, come il luogo dove si troverebbe Ados — sconsigliando però di andarci. Il party si è recato a Fonte Verde ed è finito in un rituale notturno (vedi Sessione 4). Ados stesso non si è ancora fatto vedere in scena nemmeno dopo gli eventi della Sessione 5 nel villaggio dei villici — resta disperso."
      },
      {
        id: "lilglia", nome: "Lilglia", iniziali: "L", colore: "#c4954a",
        tag: ["Moglie di Ados", "Guaritrice", "Deceduta"],
        testo: "Moglie di Ados, grande guaritrice del gruppo. Morta di recente all'età di 82 anni (dettaglio raccontato da Whilliam in Sessione 3). Il tempio dove il gruppo trovò gli otto frammenti fu anche il luogo in cui lei e Ados si dichiararono per la prima volta il proprio amore. **Sessione 5:** la creatura non-morta in cui era diventata (vedi Fonte Verde, Sessione 4) è stata affrontata e uccisa definitivamente nel villaggio dei villici — Zoraya le ha imposto la verità in faccia facendola crollare, Rei l'ha decapitata."
      },
      {
  ...
  puntiDiVista: {
    rei: {
      ...
      sezioni: [
        {
          label: "Ultima sessione — Il villaggio dei villici e il mattino dopo",
          testo: "Proseguendo la visione appena iniziata a Fonte Verde, Furiosa le mostra come le sue armi — i \"tridenti\", ora percepiti come portatori di un'anima rossa — siano percepibili entro 9 metri e richiamabili direttamente a sé; la catena/lama assorbe il sangue versato, diventando più pesante quanto più ne assorbe. Le indica alcune emozioni da \"coltivare\" — gioia, disgusto, fierezza, e la tristezza, che rilegge come \"senso di appartenenza\" — descrivendole come \"quelle a cui dai da mangiare\". Le dice che la vita si aggrappa con tutte le forze al voler restare, che lei è la sua campionessa, e che seguendola potrà, piano, recuperare ciò che ha perso.\n\nNello scontro con la creatura gigantesca in cui la donna sfigurata si è trasformata, Rei le salta a cavalcioni sul collo bloccandole le braccia subito dopo che Zoraya le ha urlato la verità in faccia facendola crollare — la riconosce e la chiama per nome, Lilglia, prima di deciderne la sorte e tagliarle la testa di netto con le lame incrociate.\n\nAl mattino, durante il confronto sincero del gruppo, Zoraya e Nikla le dicono di averla sentita parlare con due voci diverse durante una vecchia convulsione alla locanda di Whilliam — un ricordo che lei stessa non ha, ma che nessuna delle due sembra inventarsi. Il gruppo decide di restare unito, diretto verso Pozzprofond e poi Tresil."
        },
        {
    ...
    zoraya: {
      ...
      sezioni: [
        {
          label: "Ultima sessione — Il villaggio dei villici e il mattino dopo",
          testo: "Proseguendo la visione, Furiosa la chiama sua campionessa e le rivolge un discorso più esteso: la chiama \"povera creatura schiacciata e vessata perché accetti ciò che rende ciechi gli altri\", promette che insieme faranno ardere \"le fiamme della vera verità\" così luminose che nessuno potrà più ignorarle, e le chiede di crescere, diventare più potente e ricomporla. Zoraya ottiene due nuove capacità: può percepire le intenzioni di una persona e, se conformi a quanto si aspetta, imporle una verità che è costretta a riconoscere anche contro la propria volontà; e può potenziare il proprio corpo — più veloce, più forte, più resistente, con la percezione del tempo rallentata.\n\nUsa entrambe le capacità nello scontro con la creatura gigantesca in cui la donna sfigurata si è trasformata: le tiene il volto tra le mani e le urla la verità — \"Tu sei morta, sei un cadavere e stai mangiando cadaveri\" — e la creatura, per la prima volta, sembra riconoscersi e crolla a terra faccia in avanti; subito dopo Rei la decapita. Il prezzo per aver spinto entrambi i poteri al massimo è quasi letale: Zoraya smette di riuscire a respirare, inizia a \"fumare\"/sublimare dal corpo, rischia il soffocamento — capillari che scoppiano, occhi arrossati — prima di riprendere fiato tra vomito e convulsioni. Il giorno dopo si sveglia con un dolore muscolare esteso a tutto il corpo, come se ogni muscolo fosse stato allenato più volte nello stesso giorno; nessuno, lei compresa, comprende ancora del tutto cosa le sia davvero successo.\n\nAl mattino, riunitisi a parlarsi con sincerità, i quattro concordano di essere stati scelti da Furiosa e decidono di restare uniti, dirigendosi verso Pozzprofond e poi Tresil."
        },
        {
          label: "Fonte Verde e la visione di Furiosa",
    ...
    nikla: {
      ...
      sezioni: [
        {
          label: "Ultima sessione — Il villaggio dei villici e il mattino dopo",
          testo: "Ferita gravemente durante lo scontro nel villaggio (lo sterno quasi spaccato), Nikla tenta l'incantesimo di rigenerazione della carne su di sé — \"morta per morta\" — chiedendosi quale valore avesse ancora l'inchiostro che le restava: Furiosa, nella visione, le aveva ribadito che l'inchiostro usato deve avere valore perché l'incantesimo funzioni davvero. Mentre lo lancia, qualcosa dentro di lei si muove: dal petto e dal ventre le emergono più volte dita lunghissime, una mano, forse anche una mezza faccia — non ha idea di cosa sia, e la spaventa profondamente. Karl le taglia via quelle dita col proprio pugnale e le sigilla la zona con una piastra di metallo; il fenomeno si ripete una seconda volta quando riprova l'incantesimo, consumando l'inchiostro visibile sotto la pelle fino a lasciarne solo un residuo. Le dita/mani coinvolte restano di un viola scuro, come un livido enorme.\n\nAl mattino, durante il confronto sincero del gruppo, sia lei che Zoraya ricordano di aver sentito Rei parlare con due voci diverse durante una vecchia convulsione alla locanda di Whilliam. Il gruppo decide comunque di restare unito, diretto verso Pozzprofond e poi Tresil."
        },
        {
          label: "Fonte Verde e la visione di Furiosa",
        ...
        {
          label: "Domande che si porta dietro",
          testo: "Cos'era quella cosa che la tirava via durante la visione di Furiosa, e cosa intendeva Furiosa per \"codice sorgente\"? E ora: cosa fossero davvero quelle dita e quella mano che le sono emerse dal corpo durante l'incantesimo."
        }
      ]
    },
    karl: {
      ...
      sezioni: [
        {
          label: "Ultima sessione — Il villaggio dei villici e il mattino dopo",
          testo: "Proseguendo la visione, Furiosa gli mostra diverse visioni in cui non riesce a salvare Claudia ed Hetel, sempre e comunque — per fargli capire che ciò che è andato perduto non si può recuperare: \"il passato è passato\". Ma gli mostra anche che si può combattere perché nessun altro debba mai più perdere le persone care che danno senso alla propria vita. Gli chiede di ergersi a suo campione e gli promette un mondo dove non sia più possibile uccidere violentemente chi vuole vivere. Si chiarisce meglio il funzionamento del suo dono: può impedire che chi non vuole morire, muoia — ma solo se la vittima stessa si aggrappa alla vita con la propria volontà (non è resurrezione garantita), e ogni utilizzo gli costa un'unghia, di cui non ne ha infinite.\n\nNello scontro con la creatura del villaggio, Karl salva ripetutamente Nikla: recupera il metallo per curarla, arma un pugnale per tagliarle via le dita che le emergono dal corpo durante l'incantesimo, forma una lastra di metallo per contenerle, e sigilla porte e finestre della capanna con le piastre di metallo delle guardie per proteggere il gruppo durante la notte. Nei momenti in cui aiuta qualcuno a sopravvivere è lucido e non soffre — sente che è la sua strada verso la redenzione. Al mattino, durante il confronto sincero del gruppo, è lui a proporre di restare uniti e a indicare la rotta pratica: prima Pozzprofond, per recuperare i cavalli lasciati lì, poi Tresil."
        },
        {
          label: "Fonte Verde e la visione di Furiosa",
        ...
        {
          label: "Domande che si porta dietro",
          testo: "Perché vede questi punti rossi — sulla bambina che ha salvato, su Nikla, su Rei, su Zoraya — e cosa li lega tra loro. Se abbia senso, per lui, restare con un gruppo che ha appena visto — e fatto — cose che preferirebbe non aver mai visto. Se accettare o no di diventare il campione di Furiosa. Quante unghie gli restano, e cosa succederà quando finiranno."
        }
      ]
    }
  },
  ...
  sessioni: [
    ...
    },
    {
      ...
      approfondimenti: [
        ...
        {
          titolo: "Nota DM — misteri aperti emersi in questa sessione",
          testo: "Chi sia davvero la donna sfigurata del rituale, e se sia sopravvissuta all'incendio nonostante la mano recisa — risolto in Sessione 5. Cosa ne è stato di Ados e del Gran Sacerdote — il Gran Sacerdote risolto in Sessione 5, Ados resta disperso. Se e come i quattro PG risponderanno alle rispettive offerte di Furiosa — nessuno ha ancora accettato o rifiutato formalmente in scena. (Le risposte che il DM già conosce per i primi due punti sono in Lore Segreta, non qui: questa pagina resta visibile anche in modalità Giocatore.)"
        }
      ]
    },
    {
      data: "Sessione 5",
      titolo: "Il villaggio dei villici — la fine di Lilglia",
      luogo: "Villaggio dei villici, presso Fonte Verde",
      riassunto: "Proseguimento diretto della Sessione 4: nel villaggio dei villici vicino a Fonte Verde, la creatura gigantesca in cui la donna sfigurata (Lilglia) si è trasformata continua a nutrirsi dei cadaveri lasciati sul campo, strappando e ingoiando teste intere. Zoraya la affronta, le tiene il volto tra le mani e le urla in faccia la verità — \"Tu sei morta, sei un cadavere e stai mangiando cadaveri\". La creatura sgrana gli occhi, sembra riconoscersi, e crolla a terra faccia in avanti: Rei le salta a cavalcioni sul collo, la chiama per nome e le taglia la testa di netto con le lame incrociate. Il Gran Sacerdote muore anch'esso nel caos, devorato dalla creatura.\n\nDurante e dopo lo scontro emergono i costi dei nuovi poteri: Zoraya, dopo aver spinto al massimo verità e potenziamento fisico, rischia il soffocamento (sublimazione dal corpo, capillari che scoppiano) prima di riprendere fiato tra vomito e convulsioni, e il giorno dopo si sveglia con un dolore muscolare esteso a tutto il corpo. Nikla, gravemente ferita, scopre che l'inchiostro usato \"deve avere valore\"; durante il proprio incantesimo di rigenerazione le emergono più volte dal corpo dita lunghissime e una mano, che Karl taglia e sigilla con il metallo — fenomeno inspiegato per tutti i personaggi. Karl chiarisce il funzionamento del proprio potere (impedire la morte a chi vuole vivere, al costo di un'unghia per uso) e salva ripetutamente Nikla, sigillando anche la capanna del gruppo per la notte.\n\nAl mattino, i quattro si confrontano sinceramente sulle rispettive visioni di Furiosa: emerge che anche a Zoraya e Rei, non solo a Karl, è stato rivolto un linguaggio da \"campionessa/campione\". Zoraya e Nikla ricordano a Rei di averla sentita parlare con due voci diverse durante una vecchia convulsione alla locanda di Whilliam — episodio che la trascrizione della Sessione 3 confermerebbe realmente accaduto. Concordano di essere stati scelti da Furiosa e decidono di restare uniti, dirigendosi verso Pozzprofond (per recuperare i cavalli lasciati lì) e poi verso Tresil.",
      eventiChiave: [
        "La creatura in cui Lilglia si è trasformata continua a nutrirsi dei cadaveri nel villaggio",
        "Zoraya le impone la verità in faccia con la sua nuova capacità; la creatura crolla",
        "Rei la chiama per nome (Lilglia) e la decapita — morte definitiva",
        "Il Gran Sacerdote muore, devorato dalla creatura nel caos",
        "Zoraya rischia il soffocamento dopo aver spinto al massimo i suoi nuovi poteri; dolori estesi il giorno dopo",
        "Nikla scopre la regola del \"valore dell'inchiostro\"; un fenomeno inspiegato le emerge dal corpo durante l'incantesimo",
        "Karl chiarisce il costo del proprio potere (un'unghia per uso) e salva ripetutamente Nikla",
        "Al mattino, il gruppo si confronta sinceramente sulle visioni di Furiosa — linguaggio da \"campione/campionessa\" estesosi a Zoraya e Rei",
        "Zoraya e Nikla ricordano a Rei di aver parlato con due voci — confermato dalla Sessione 3",
        "Il gruppo decide di restare unito e parte verso Pozzprofond, poi Tresil"
      ],
      tag: ["Fonte Verde", "Furiosa", "Lilglia", "Visioni"],
      nuova: true,
      economia: [],
      oggetti: [],
      approfondimenti: [
        {
          titolo: "Fonte",
          testo: "Trascrizione automatica (Plaud) della seduta del 17 settembre 2026, con speaker generici non etichettati per nome (a differenza della Sessione 3) — dedotti dal contenuto. Chiarimenti aggiuntivi ricevuti direttamente dall'utente."
        },
        {
          titolo: "Nota DM — misteri aperti emersi in questa sessione",
          testo: "Cosa sia davvero il fenomeno delle dita/mani/volto che emergono dal corpo di Nikla durante i suoi incantesimi — i personaggi non lo sanno (vedi Lore Segreta per la risposta, non accessibile ai giocatori)."
        }
      ]
    }
  ],
  ...
  thread: {
    sviluppo: [
      ...
      { id: "th-24", testo: "**[PARZIALMENTE RISOLTO Sessione 5]** Cosa ne è stato di Ados e del Gran Sacerdote dopo il rituale di Fonte Verde — il Gran Sacerdote è morto (devorato da Lilglia); Ados resta disperso, non ancora apparso in scena." },
      { id: "th-25", testo: "**[RISOLTO Sessione 5]** Lilglia (la donna sfigurata, non-morta) è stata affrontata e uccisa definitivamente nel villaggio dei villici (Zoraya le impone la verità, Rei la decapita)." },
      { id: "th-27", testo: "Se e come i quattro PG risponderanno alle rispettive offerte di Furiosa — in Sessione 5 il gruppo ha deciso di restare unito come gruppo scelto da Furiosa, ma nessuno ha ancora accettato o rifiutato formalmente il patto in scena." },
      ...
      { id: "th-30", testo: "Cosa sia davvero il fenomeno delle dita/mani/volto che emergono dal corpo di Nikla durante i suoi incantesimi (Sessione 5) — i PG non lo sanno (vedi Lore Segreta, \"Nikla — l'incubo nell'inchiostro\", per la risposta del DM)." },
      { id: "th-32", testo: "Formalizzare meccanicamente la regola del \"valore dell'inchiostro\" di Nikla e il costo in unghie del potere di Karl." }
    ]
  }
