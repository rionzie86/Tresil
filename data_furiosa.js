...
const FURIOSA_DATA = {
  ...
  puntiDiVista: {
    ...
    nikla: {
      ...
      sezioni: [
        ...
        {
          label: "Domande che si porta dietro",
          testo: "Cos'era quella cosa che la tirava via durante la visione di Furiosa, e cosa intendeva Furiosa per \"codice sorgente\"? E ora: cosa fossero davvero quelle dita e quella mano che le sono emerse dal corpo durante l'incantesimo — e se Zoraya si sia davvero sbagliata su di lei e sulle \"due voci\", o se ci sia qualcosa che nemmeno lei stessa ricorda."
        }
      ]
    },
    karl: {
  ...
  sessioni: [
    ...
    },
    {
      ...
      eventiChiave: [
        ...
        "Nuovo mistero: Zoraya accusa Nikla di aver parlato con due voci — negato da Nikla",
        "Incontro con un nuovo spirito, il \"venerabile Yokai\"",
  ...
  thread: {
    sviluppo: [
      ...
      { id: "th-29", testo: "Chi è il \"venerabile Yokai\" (uno degli spiriti shizenka) incontrato in Sessione 5, e cosa vuole dal party." },
      ...
      { id: "th-31", testo: "Se e quando il gruppo scoprirà che è stata Rei, non Nikla, a parlare con due voci durante una convulsione in Sessione 3 (confuso da Zoraya in Sessione 5)." },
