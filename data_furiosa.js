...
// aggiornati al 24 settembre 2026 con: le schede dei quattro
// giocatori (Zoraya, Nikla, Karl, Rei), il diario in-play di Rei
// (giorni 8-9 del terzo mese), la scaletta scene/colonna sonora
// delle prime due sessioni giocate al tavolo, la trascrizione
// Plaud della Sessione 3 (2-3 settembre 2026, conclusione dello
// scontro alla Rosa Storta e racconto completo di Whilliam), la
// trascrizione della Sessione 4 (11 settembre 2026, Fonte Verde
// e le visioni di Furiosa) e quella della Sessione 5 (17 settembre
// 2026, il villaggio dei villici e la fine di Lilglia).
// ============================================================
...
const FURIOSA_DATA = {
  ...
  personaggi: {
    pg: [
      ...
      },
      {
        ...
        loreMaster: "Personaggio non presente nei documenti di sviluppo originali — emerso solo dalla scheda ricevuta il 1 settembre 2026, poi consolidato come quarto membro stabile del party nelle sessioni successive. Chi sia davvero la bambina salvata (Sessione 3, poi sviluppata nella sessione narrativa 1:1 del 19 settembre 2026, vedi sotto) resta un'estranea senza nome per Karl e per il tavolo — non un aggancio narrativo ancora aperto, solo un dettaglio biografico chiuso in sé.\n\nSessione 3: la vista dei \"punti rossi\" di pericolo/connessione NON nasce con il guanto d'arme — Karl la manifesta per la prima volta poche ore prima di arrivare alla Rosa Storta, mentre salva una bambina da un uomo che voleva farle del male; si ripete poco dopo vedendo Nikla e Rei entrare nella locanda, e ancora vedendo Zoraya scendere le scale — sulle tre ragazze un oggetto risalta enormemente nella sua vista sfocata (la cintura di Nikla, il fermaglio di Zoraya). Capacità ancora senza spiegazione neppure per i giocatori stessi. Solo dopo, dentro la locanda, Whilliam gli fa indossare un guanto d'arme di famiglia: frammenti del guanto gli penetrano dolorosamente nella mano per fissare e riparare lentamente i tessuti rotti al suo interno — è la funzione dell'armatura di Whilliam, un effetto distinto e non collegato ai punti rossi.\n\nSessione 4 (Fonte Verde): nel combattimento contro il \"Gran Sacerdote\" e la donna sfigurata, Karl le strappa dal collo l'anello di metallo con i frammenti rosso sangue — lei gli infila la mano nel costato spezzandogli due costole, e viene salvato da Zoraya che le recide la mano. Incastra in quell'anello il proprio frammento e quello di Rei e tenta di aggiungere anche quelli di Nikla: si verifica un blackout sensoriale seguito da una visione di Furiosa, che gli mostra la notte in cui morirono Claudia e Hetel (con la scarsella al polso — la stessa di sempre, che porta senza mai farci caso: la paga dell'ultimo mese, la chiave di casa, il coltellino con cui intaglia il legno per un regalo alla figlia; nessun mistero, solo un dettaglio che nella visione nota per la prima volta). Furiosa gli dice che ciò che è stato è stato, che loro — Claudia ed Hetel, NON le \"Sei Madri\" di Furiosa — volevano solo vivere, si sono aggrappate alla vita con le unghie e i denti; gli chiede esplicitamente di ergersi a suo campione, e gli promette un potere descritto come \"dieci unghie, dieci vite puoi ancorare al corpo\" — risvegliando in lui un talento sopito per plasmare il metallo: il guanto d'arme non si fonde alla sua mano, è Karl a iniziare a percepirne il materiale e la sua malleabilità, sentendo che può plasmarlo con molta più facilità di prima. Nessuna risposta di Karl alla proposta ancora giocata al tavolo.\n\nSessione 5: si chiarisce il funzionamento pratico del potere — Karl può impedire che chi non vuole morire, muoia, ma solo se la vittima stessa si aggrappa alla vita con la propria volontà (non è resurrezione garantita), e il costo è un'unghia consumata per ogni utilizzo (non infinite). Salva ripetutamente Nikla in combattimento e sigilla la capanna del gruppo per la notte. Si orienta con sempre più convinzione verso un arco di redenzione tramite la protezione altrui, ed è lui a proporre al gruppo, al mattino, di restare unito e di dirigersi verso Pozzprofond e poi Tresil.\n\nSessione narrativa 1:1 col giocatore (19 settembre 2026) — sviluppo psicologico e morale di Karl, materiale di costruzione del personaggio, non ancora tradotto in scena: prima di incontrare il party, Karl era ridotto all'ombra di se stesso — ritrovato a Tresil circa due settimane dopo il massacro di Claudia ed Ethel, in un vicolo, praticamente in fin di vita, la vista sfocata e ormai priva di colori per la denutrizione, senza più alcuna relazione né volontà di vivere: si stava lasciando morire. Prima di questo stato, da giovane era \"fondamentalmente svogliato\", senza applicazione né negli studi né nel lavoro col padre (artigiano di legno e metallo, mai capace di dare un senso \"scientifico\" al talento innato del figlio per piegare il metallo) — finché non incontra Claudia, giovane di famiglia più abbiente che rimane incinta; ripudiata dalla propria famiglia per la scelta, la coppia si trasferisce fuori dalle mura, e Karl si arruola per la prima volta in qualcosa con intenzione — la guardia cittadina, turni notturni più redditizi — per mantenerle. Nasce Ethel; qualche anno dopo, durante una delle sue ronde notturne, dei briganti si introducono in casa e le uccidono entrambe. È lì che Karl \"si rompe\": vaga per le strade senza meta, smette di mangiare e bere, abbandona persino spada e armatura perché troppo debole per portarle — una fuga simbolica dall'accettazione dell'accaduto.\n\nL'episodio della bambina salvata (poco prima di arrivare alla Rosa Storta, la sera stessa) è il punto di rottura di questa apatia, non solo l'origine della vista rossa: mentre è ormai in fin di vita in un vicolo, la sua attenzione viene catturata da un ciondolo rosso — una bambina che corre verso di lui inseguita da un uomo con intenzioni predatorie e violente. Karl, con un'energia che non sapeva di avere, interviene e lo affronta: uno scontro duro e a due riprese (viene ferito, quasi sopraffatto, l'uomo torna verso la bambina e la tramortisce con uno schiaffo prima che Karl si rialzi una seconda volta, \"vedendo rosso\" al punto da non sentire più il dolore, e lo spinga giù da una ringhiera, uccidendolo). Subito dopo, i genitori arrivano, riprendono la bambina e passano davanti a Karl senza guardarlo, senza un grazie: questa totale indifferenza — non cercava gratitudine, ma la scena la sottolinea comunque — è parte della ricompensa interiore che l'evento gli lascia: non l'esterno, ma la pace momentanea data dall'atto stesso. È questo, non il guanto d'arme, l'evento scatenante che lo porta, poche ore dopo, alla Rosa Storta ancora vivo.\n\nDopo la visione di Furiosa (Sessione 4), Karl trova per la prima volta da mesi un \"piglio vitale\" — non un processo consapevole, ma una spinta interiore che lo sta salvando dalla propria disperazione suicida. Meccanica emotiva chiave (non ancora messa in parole dal personaggio stesso): salvare un innocente gli permette di percepire, come un \"effetto a farfalla\", il bene che quella persona salvata potrà ancora portare al mondo — l'unica sensazione rimasta che si avvicini a quello che provava per la propria famiglia. All'inizio è un impulso quasi egoistico, quasi una dipendenza (\"come un drogato, riceve la sua dose di felicità che va a nascondere la tristezza di base del personaggio\"): si sente più leggero, con meno \"malinconia profonda\", e per la prima volta sente che c'è qualcosa di positivo che va oltre il negativo — si fida di questa nuova via perché *sente* che funziona, non per fede cieca in Furiosa.\n\nDa questa spinta sta nascendo, ancora in modo incosciente e non formalizzato, un codice morale personale, costruito a posteriori sulle parole di Furiosa e non dettato da lei: **\"vita la vita, morte la morte\"** — chi vuole vivere e si trova nella posizione dell'innocente ha diritto alla possibilità di sopravvivere; chi invece prevarica la vita altrui per un proprio tornaconto, minacciando un indifeso, merita la morte, perché sta prevaricando \"l'unica cosa fondamentale dell'esistenza\" — per lui non è contemplata la redenzione di chi spezza una vita. Nella vita quotidiana questo si traduce in una tutela istintiva dell'indifeso contro chi cerca di approfittarsene (\"non gli piacciono i bulli\"). Il codice si intreccia con la morale ferrea del padre, ma la pulsione inconscia lo porta a reinterpretarla selettivamente — ad esempio scartando il principio del \"non uccidere\" quando si trova di fronte a chi minaccia un indifeso. Non è ancora un trattato scritto: Karl lo costruirà strada facendo, forse fissandolo in poche frasi personali a cui riagganciarsi nei gesti del quotidiano, mai in un codice rigido di centinaia di pagine.",
        note: ""
      },
      {
    ...
    karl: {
      ...
      sezioni: [
        ...
        },
        {
          ...
          testo: "Poche ore prima di entrare alla Rosa Storta, ormai allo stremo e senza meta in un vicolo, qualcosa cattura per la prima volta da giorni la sua attenzione: un ciondolo rosso, una bambina che corre verso di lui — per un attimo, nella sua vista annebbiata, gli sembra quasi un'apparizione. Poi vede l'uomo che la insegue, e capisce subito che le sue intenzioni non sono innocenti. Interviene senza pensarci, con una forza che non sapeva di avere ancora; lo scontro è duro — l'uomo lo ferisce, lo mette quasi a terra, torna verso la bambina — ma Karl si rialza una seconda volta, non sente più il dolore, vede solo rosso, e la finisce spingendo l'uomo giù da una ringhiera.\n\nI genitori arrivano subito dopo, la riprendono in braccio e gli passano davanti senza guardarlo, senza una parola. Non se lo aspettava diversamente, eppure quel silenzio gli resta addosso — insieme alla domanda che non si pone spesso: agisce d'istinto, senza esitare, eppure non ricorda di essere mai stato così pronto a intervenire prima — un gesto che non sa ancora bene come conciliare con quello che ricorda della propria vita a Ferrath."
        },
        {
          label: "Domande che si porta dietro",
  ...
  // Cronologia sessioni — cinque sessioni giocate finora.
  // Il "Blocco 5" della scaletta manoscritta originale (villaggio,
  // rituale/scontro con Lilglia) è stato giocato a cavallo tra la
  // Sessione 4 (Fonte Verde, 11 settembre 2026) e la Sessione 5
  // (il villaggio dei villici, 17 settembre 2026).
